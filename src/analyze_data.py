...
def get_osd_379_images():
     # OSD-379 URL處理邏輯
     osd_379_description_image_url = "https://github.com/saxophonesam/NASA-OSDR-Visualize-Tool/blob/main/image/OSD-379/Experiment-Description.png?raw=true"
     ...
     return [
          html.Img(src=osd_379_description_image_url, style={'width': '100%', 'height': 'auto'}),  # Background區塊顯示圖片
...
def get_osd_665_images():
     # OSD-665 URL處理邏輯
     osd_665_description_image_url = "https://github.com/saxophonesam/NASA-OSDR-Visualize-Tool/blob/main/image/OSD-665/Experiment-Description.png?raw=true"
     ...
     return [
          html.Img(src=osd_665_description_image_url, style={'width': '100%', 'height': 'auto'}),  # Background區塊顯示圖片
...
def get_compare_images():
     # Compare URL處理邏輯
     compare_description_image_url = "https://github.com/saxophonesam/NASA-OSDR-Visualize-Tool/blob/main/image/Compare/Experiment-Description.png?raw=true"
     ...
     return [
          html.Img(src=compare_description_image_url, style={'width': '100%', 'height': 'auto'}),  # Background區塊顯示圖片
